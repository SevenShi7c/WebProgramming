...
<main class="app-content">
  <div class="app-title">
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><a href="admin/manage-product">Quản lý đơn đặt</a></li>
      <li class="breadcrumb-item">Chỉnh sửa đơn đặt</li>
    </ul>
  </div>
  <div class="row" id="change_product">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Chỉnh sửa đơn đặt</h3>
        <div class="tile-body">
          <form action="<%=pageContextPath%>/admin/manage-confirm?type=edit&id-confirm=<%=booking==null?"":booking.getId()%>"
            ...
            <div class="row">
              <div class="form-group col-md-3">
                ...
                <input class="form-control" type="number" placeholder="" name="id-confirm"
