...
function addBtnCart() {
    if (count < 2) {
        count++;
        var createBtnCart = `<a class="btn btn-primary btn-add-cart" href="http://localhost:63342/WebProgramming/cart.html">Xem giỏ hàng</a>`
        $("#PPMiniCart").append(createBtnCart);
    }
}
