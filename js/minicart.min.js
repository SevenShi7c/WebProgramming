...
function getCartFromLocalStorage() {
    return JSON.parse(decodeURIComponent(localStorage.getItem('PPMiniCart')));
}
...
function getImage() {
    ...
    // divImage.innerText = getCartFromLocalStorage().value.items[getIdItem].image;
    return divImage;
}

// decreasesQuantity
var cart = getCartFromLocalStorage().value.items;
